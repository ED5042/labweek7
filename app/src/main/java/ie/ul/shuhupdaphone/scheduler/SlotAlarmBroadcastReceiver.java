...
public class SlotAlarmBroadcastReceiver extends BroadcastReceiver {
	...
	public static boolean scheduleNextAlarm(Context appContext)
    {
		...
		if (cursor.moveToFirst()) {
	        ...
	        finally 
	        {
	            ...
	            if (DEBUG) Log.e(TAG, "Silence phone at: " +ModuleDatabase.defaultFormatter.format(getStartTime(cursor))+":00:00");
	...
	private static void scheduleRevert(Context appContext, Date endTime, int mode) {
        ...
        finally 
        {
            ...
            if (DEBUG) Log.e(TAG, "Revert phone at " +ModuleDatabase.defaultFormatter.format(endTime)+":00:00");
        }
	}
